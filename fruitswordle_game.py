...
# ตรวจสอบการแสดงข้อความชนะ/แพ้ (ย้ายมาไว้ข้างบนเพื่อให้แสดงผลทันทีหลังรีเฟรช)
ifรอบปัจจุบัน > 0:
  คำทายล่าสุด = st.session_state.ประวัติการทาย[-1][0]
  if คำทายล่าสุด == st.session_state.คำปริศนา:
